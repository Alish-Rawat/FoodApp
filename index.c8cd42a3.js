...
// because we don't serialize SSR stack traces for security reasons
t.stack="",n[e]=t}}else n[e]=r;return n}(r.errors)})),r),routes:e,mapRouteProperties:s.UNSAFE_mapRouteProperties,window:null==t?void 0:t.window}).initialize()}let v=/*#__PURE__*/l.createContext({isTransitioning:!1}),y=l.startTransition;class g{constructor(){this.status="pending",this.promise=new Promise((e,t)=>{this.resolve=t=>{"pending"===this.status&&(this.status="resolved",e(t))},this.reject=e=>{"pending"===this.status&&(this.status="rejected",t(e))}})}}/**
 * Given a Remix Router instance, render the appropriate UI
 */function b(e){let{fallbackElement:t,router:n,future:r}=e,[o,a]=l.useState(n.state),[i,u]=l.useState(),[c,f]=l.useState({isTransitioning:!1}),[d,p]=l.useState(),[h,m]=l.useState(),[b,S]=l.useState(),{v7_startTransition:x}=r||{},k=l.useCallback(e=>{x&&y?y(e):e()},[x]),E=l.useCallback((e,t)=>{let{unstable_viewTransitionOpts:r}=t;r&&null!=n.window&&"function"==typeof n.window.document.startViewTransition?h&&d?(// Interrupting an in-progress transition, cancel and let everything flush
...
u(e),f({isTransitioning:!0,currentLocation:r.currentLocation,nextLocation:r.nextLocation})):k(()=>a(e))},[k,h,d,n.window]);// Need to use a layout effect here so we are subscribed early enough to
...
// happened)
l.useEffect(()=>{if(d&&i&&n.window){let e=d.promise,t=n.window.document.startViewTransition(async()=>{k(()=>a(i)),await e});t.finished.finally(()=>{p(void 0),m(void 0),u(void 0),f({isTransitioning:!1})}),m(t)}},[k,i,d,n.window]),// When the new location finally renders and is committed to the DOM, this
...
l.useEffect(()=>{!c.isTransitioning&&b&&(u(b.state),f({isTransitioning:!0,currentLocation:b.currentLocation,nextLocation:b.nextLocation}),S(void 0))},[c.isTransitioning,b]);let _=l.useMemo(()=>({createHref:n.createHref,encodeLocation:n.encodeLocation,go:e=>n.navigate(e),push:(e,t,r)=>n.navigate(e,{state:t,preventScrollReset:null==r?void 0:r.preventScrollReset}),replace:(e,t,r)=>n.navigate(e,{replace:!0,state:t,preventScrollReset:null==r?void 0:r.preventScrollReset})}),[n]),C=n.basename||"/",j=l.useMemo(()=>({router:n,navigator:_,static:!1,basename:C}),[n,_,C]);// The fragment and {null} here are important!  We need them to keep React 18's
// useId happy when we are server-rendering since we may have a <script> here
// containing the hydrated server-side staticContext (from StaticRouterProvider).
// useId relies on the component tree structure to generate deterministic id's
// so we need to ensure it remains the same on the client even though
// we don't need the <script> tag
return /*#__PURE__*/l.createElement(l.Fragment,null,/*#__PURE__*/l.createElement(s.UNSAFE_DataRouterContext.Provider,{value:j},/*#__PURE__*/l.createElement(s.UNSAFE_DataRouterStateContext.Provider,{value:o},/*#__PURE__*/l.createElement(v.Provider,{value:c},/*#__PURE__*/l.createElement(s.Router,{basename:C,location:o.location,navigationType:o.historyAction,navigator:_},o.initialized?/*#__PURE__*/l.createElement(w,{routes:n.routes,state:o}):t)))),null)}function w(e){let{routes:t,state:n}=e;return(0,s.UNSAFE_useRoutesImpl)(t,void 0,n)}let S="undefined"!=typeof window&&void 0!==window.document&&void 0!==window.document.createElement,x=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,k=/*#__PURE__*/l.forwardRef(function(e,t){let n,{onClick:r,relative:o,reloadDocument:a,replace:i,state:d,target:h,to:m,preventScrollReset:v,unstable_viewTransition:y}=e,g=f(e,p),{basename:b}=l.useContext(s.UNSAFE_NavigationContext),w=!1;if("string"==typeof m&&x.test(m)&&(// Render the absolute href server- and client-side
n=m,S))try{let e=new URL(window.location.href),t=new URL(m.startsWith("//")?e.protocol+m:m),n=(0,u.stripBasename)(t.pathname,b);t.origin===e.origin&&null!=n?m=n+t.search+t.hash:w=!0}catch(e){}// Rendered into <a href> for relative URLs
let k=(0,s.useHref)(m,{relative:o}),E=/**
 * Handles the click behavior for router `<Link>` components. This is useful if
 * you need to create custom `<Link>` components with the same click behavior we
 * use in our exported `<Link>`.
 */function(e,t){let{target:n,replace:r,state:o,preventScrollReset:a,relative:i,unstable_viewTransition:c}=void 0===t?{}:t,f=(0,s.useNavigate)(),d=(0,s.useLocation)(),p=(0,s.useResolvedPath)(e,{relative:i});return l.useCallback(t=>{0!==t.button||// Ignore everything but left clicks
n&&"_self"!==n||t.metaKey||t.altKey||t.ctrlKey||t.shiftKey||(t.preventDefault(),f(e,{replace:void 0!==r?r:(0,u.createPath)(d)===(0,u.createPath)(p),state:o,preventScrollReset:a,relative:i,unstable_viewTransition:c}))},[d,f,p,r,o,n,e,a,i,c])}(m,{replace:i,state:d,target:h,preventScrollReset:v,relative:o,unstable_viewTransition:y});return /*#__PURE__*/l.createElement("a",c({},g,{href:n||k,onClick:w||a?r:function(e){r&&r(e),e.defaultPrevented||E(e)},ref:t,target:h}))});(r=a||(a={})).UseScrollRestoration="useScrollRestoration",r.UseSubmit="useSubmit",r.UseSubmitFetcher="useSubmitFetcher",r.UseFetcher="useFetcher",r.useViewTransitionState="useViewTransitionState",(o=i||(i={})).UseFetchers="useFetchers",o.UseScrollRestoration="useScrollRestoration"}),p("kPnuz",function(t,n){var r,o,a,i;/**
